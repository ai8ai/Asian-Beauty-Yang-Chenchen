...
const yccCate: Cate[] = [
    { id: "1", title: "Cat1 - Amazing Start!", cover: srcYCC[0] },
    { id: "2", title: "Cat1 - Explore the Beauty", cover: srcYCC[1] },
    { id: "3", title: "Cat1 - Vibrant Colors", cover: srcYCC[2] },
    { id: "4", title: "Cat1 - Bold & Confident", cover: srcYCC[0] },
    { id: "5", title: "Cat1 - Artistic Vision", cover: srcYCC[1] },
    { id: "6", title: "Cat1 - Nature's Essence", cover: srcYCC[2] },
    { id: "7", title: "Cat1 - Graceful Elegance", cover: srcYCC[0] },
    { id: "8", title: "Cat1 - Iconic Moments", cover: srcYCC[1] }
];
