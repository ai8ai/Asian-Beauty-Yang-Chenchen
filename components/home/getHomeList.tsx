...
const dxyHomeCover = genCatCoverList("dxy/dc", 10).sort(() => Math.random() - 0.5);
const lxlHomeCover = genCatCoverList("lxl/lc", 10).sort(() => Math.random() - 0.5);
const anranHomeCover=genCatCoverList("anran/ac", 10).sort(() => Math.random() - 0.5);
const cccHomeCover = genCatCoverList("ccc/cc", 10).sort(() => Math.random() - 0.5);
